            ...
            div()
                ...
                .child(
                    h_flex().gap_2()
                        ...
                        .child(
                            Label::localized("You may need to configure git for Github.")
                                .size(LabelSize::Small),
                        )
                        .child(Button::localized("learn-more", "Learn more").color(Color::Accent).label_size(LabelSize::Small).on_click(|_, _, cx| {
