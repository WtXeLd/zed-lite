                    ...
                    v_flex()
                        .child(
                            h_flex()
                                ...
                                .child(
                                    Label::localized("Project is in Restricted Mode")
                ...
                status_color,
                {
                    ...
                    move |menu, _window, _cx| {
                        ...
                        if let Some(ref message) = message {
                            ...
                            submenu =
                                submenu.entry_localized("View Message", None, move |window, cx| {
                        ...
                        if has_logs {
                            ...
                            submenu =
                                submenu.entry_localized("View Logs", None, move |window, cx| {
                                    lsp_log_view::open(
                                        &lsp_logs_for_debug,
                        ...
                        submenu =
                            submenu.entry_localized("Restart Server", None, move |_window, cx| {
                        ...
                        if can_stop {
                            ...
                            submenu =
                                submenu.entry_localized("Stop Server", None, move |_window, cx| {
                                    lsp_store_for_stop
                                        .update(cx, |lsp_store, cx| {
                                            lsp_store
        ...
        div().child(
            PopoverMenu::new("lsp-tool")
                ...
                .trigger_with_tooltip(
                    ...
                    move |_window, cx| {
                        Tooltip::with_meta(
                            localization::t(cx, "Language Servers"),
                            Some(&ToggleMenu),
                            description,
                            cx,
                        )
