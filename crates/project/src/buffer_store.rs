...
use rpc::{ErrorCode, ErrorExt as _, TypedEnvelope, proto};
...
impl BufferStore {
    ...
    pub fn open_buffer(
        ...
        let task = match self.loading_buffers.entry(project_path.clone()) {
            ...
            hash_map::Entry::Vacant(entry) => {
                ...
                let BufferStoreState::Local(this) = &self.state;
    ...
    pub fn create_buffer(
        ...
        let BufferStoreState::Local(this) = &self.state;
        this.create_buffer(language, project_searchable, cx)
    }
    ...
    pub fn save_buffer(
        ...
        let BufferStoreState::Local(this) = &mut self.state;
        this.save_buffer(buffer, cx)
    }
    ...
    pub fn save_buffer_as(
        ...
        let BufferStoreState::Local(this) = &self.state;
        let task = this.save_buffer_as(buffer.clone(), path, cx);
        cx.spawn(async move |this, cx| {
            task.await?;
            this.update(cx, |this, cx| {
    ...
    pub fn register_shared_lsp_handle(
        ...
        let _ = (peer_id, buffer_id, handle);
    }
    ...
    pub fn reload_buffers(
        ...
        let BufferStoreState::Local(this) = &self.state;
        this.reload_buffers(buffers, push_to_history, cx)
    }
    ...
    pub fn wait_for_remote_buffer(
        ...
        let _ = (id, cx);
        debug_panic!("remote buffers have been removed");
        Task::ready(Err(anyhow!("remote buffers have been removed")))
    }
